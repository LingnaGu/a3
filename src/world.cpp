...

{
  ...
  for (int i=0;i<nSpheres;i++){
    ...
    yDeriv[i].q = quaternion(y[i].w.x,y[i].w.y,y[i].w.z,0);
  }
  ...
  for (int i=0;i<nSpheres;i++){
    ...
    yEnd[i].q=quaternion(y[i].q.q0+deltaT*yDeriv[i].q.q0,y[i].q.q1+deltaT*yDeriv[i].q.q1,y[i].q.q2+deltaT*yDeriv[i].q.q2,y[i].q.q3+deltaT*yDeriv[i].q.q3);
