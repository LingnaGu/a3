...

{
  ...
  bool yinside = (sphereCentre.y>= -rectangle.yDim/2.0) && (sphereCentre.y<= rectangle.yDim/2.0);
  bool xinside = (sphereCentre.x>= -rectangle.xDim/2.0) && (sphereCentre.x<= rectangle.xDim/2.0);
  ...
  if ( xinside&&yinside ) {
    ...
    *closestPoint=a.toVec3();
    return fabs(sphereCentre.z)-radius;
  ...
  vec3 p1 =vec3(rectangle.xDim/2.0,rectangle.yDim/2.0,0.0);
  vec3 p2 =vec3(-rectangle.xDim/2.0,rectangle.yDim/2.0,0);
  vec3 p3 =vec3(-rectangle.xDim/2.0,-rectangle.yDim/2.0,0);
  vec3 p4 =vec3(rectangle.xDim/2.0,-rectangle.yDim/2.0,0);
